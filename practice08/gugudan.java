...
//		int k24_i = 2; //정수형 변수 k24_i 선언 후 2로 초기화
//		while (k24_i <= 9) { //단수 2~9까지 반복
//			int k24_j = 1; //정수형 변수 k24_j 1로 초기화
//			while (k24_j <= 9) { //k24_j가 9이하까지 반복 
//				System.out.println(k24_i + " * " + k24_j + " = " + k24_i * k24_j); //출력
//				k24_j++; //1~9까지 1씩 증가
//			}
//			k24_i++; //단수 2~9까지 1씩 증가
//		}
